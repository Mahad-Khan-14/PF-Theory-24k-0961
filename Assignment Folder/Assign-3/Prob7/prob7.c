...
void displayContentMetadata(ContentMetadata **contentMatrix, int numCategories, int numContents)
{
    for (int i = 0; i < numCategories; i++)
    {
        printf("Category %d:\n", i + 1);
...
int main()
{
    ...
    // Simulate some user engagement updates
    updateEngagementScore(engagementMatrix, 0, 1, 5.0);
    updateEngagementScore(engagementMatrix, 1, 3, 3.5);
    updateEngagementScore(engagementMatrix, 2, 0, 4.5);

    // Display the engagement matrix
